...
require('lazy').setup({
  ...
  -- NOTE: Useful plugin to show you pending keybinds.
  {
    ...
    -- default event is 'VimEnter', -- Sets the loading event to 'VimEnter'
    event = 'VeryLazy',
    init = function()
      vim.o.timeout = true
  ...
  -- NOTE: Autoformat
  {
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, eixir = true, heex = true }
        return {
          timeout_ms = 500,
  ...
  -- NOTE: Treesitter
  -- code Highlight, edit, and navigation
  {
